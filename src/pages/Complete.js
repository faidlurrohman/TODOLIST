...
import {complete} from '../css/Styles';
...
export default class Complete extends Component {
  ...
  _getCurrentTasks = async (pageData, indicator) => {
    ...
    let currentTasks = await axios({
      ...
      url:
        'https://aneh-sekalian.herokuapp.com/api/v1/tasks/findTaskByCompletion?page=' +
  ...
  render() {
    ...
    return (
      <View style={complete.container}>
        <View style={complete.containerTitle}>
          <View style={{flex: 0}}>
            <Text style={complete.header}>Your Complete Tasks</Text>
          </View>
          <View style={{flexDirection: 'row'}}>
            <View style={{flex: 1}}>
              <Text style={complete.headerChild}>{currentDate}</Text>
            </View>
          </View>
        </View>
        <View style={complete.containerForm}>
          <Todo
